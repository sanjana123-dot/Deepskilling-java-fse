-- ---------------------------------------------------------------------
-- SQL Database Setup Script for orm-learn Country Table
-- ---------------------------------------------------------------------
...
-- Delete existing records before populating (Hands on 5 instructions)
TRUNCATE TABLE country;

-- Populate country table with world countries (Hands on 5 script list)
...
INSERT INTO country (co_code, co_name) VALUES ('AX', 'AX');
